...
public class Paddle {
	...
	private final int rightKey, leftKey;
	private Color color = Color.BLACK;
	private Ellipse2D.Double circle = new Ellipse2D.Double();
	public Vector position;
	
	public Paddle(double positionCoefficient, int leftKey, int rightKey) {
	...
	public void updatePosition() {
		if (Program.isPressed(leftKey))
			position.x -= speed;
		if (Program.isPressed(rightKey))
			position.x += speed;
